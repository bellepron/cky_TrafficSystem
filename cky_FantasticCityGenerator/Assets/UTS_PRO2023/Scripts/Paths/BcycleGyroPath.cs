...
{
    [Tooltip("Bicyclist Speed")] public float moveSpeed = 8.0f;
    [Tooltip("Acceleration")] public float increaseSpeed = 2.0f;
    [Tooltip("Braking")] public float decreaseSpeed = 5.0f;
    [Range(0.1f, 5.0f)] [Tooltip("Offset from the line along the X axis")] public float randXPos = 0.1f;
    [Range(0.1f, 5.0f)] [Tooltip("Offset from the line along the Z axis")] public float randZPos = 0.1f;
    ...
    [HideInInspector] [SerializeField] [Tooltip("Customize your animation speed")] private bool _overrideDefaultAnimationMultiplier = true;
    [HideInInspector] [SerializeField] [Tooltip("Animation speed")] private float _customAnimationMultiplier = 2.0f;
    [Tooltip("Distance to next point")] public float nextPointThreshold = 3;
