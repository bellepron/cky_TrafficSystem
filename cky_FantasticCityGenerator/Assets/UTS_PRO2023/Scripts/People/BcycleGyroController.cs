...
public class BcycleGyroController : MonoBehaviour
{
    ...
    [Tooltip("Speed bicyclist")] public float moveSpeed;
    [Tooltip("Acceleration")] public float increaseSpeed;
    [Tooltip("Braking")] public float decreaseSpeed;
    [Tooltip("Swing speed")] public float speedRotation;
    [HideInInspector] public bool insideSemaphore;
    [HideInInspector] public bool tempStop;

    [SerializeField][Tooltip("Set your animation speed")] private bool _overrideDefaultAnimationMultiplier;
    [SerializeField][Tooltip("Animation speed")] private float _customAnimationMultiplier = 1f;

    public float CustomAnimationMultiplier { get { return _customAnimationMultiplier; } set { _customAnimationMultiplier = value; } }
    public float SPEED_ROTATION { get { return speedRotation; } set { speedRotation = value; } }
    public bool OverrideDefaultAnimationMultiplier { get { return _overrideDefaultAnimationMultiplier; } set { _overrideDefaultAnimationMultiplier = value; } }
