    ...
    private void ApplyDrive(float accel, float footbrake)
    {
        ...
        switch (m_CarDriveType)
        {
            ...
            case CarDriveType.FrontWheelDrive:
                ...
                carWheels.WheelColliders[0].motorTorque = carWheels.WheelColliders[1].motorTorque = thrustTorque;
                break;
        ...
        for (int i = 0; i < carWheels.WheelColliders.Length; i++)
        {
            ...
            else if (footbrake > 0)
            {
                ...
                carWheels.WheelColliders[i].motorTorque = -m_ReverseTorque * footbrake;
            }
        }
    }
