...
{
    public class WaypointsContainer_Car : MonoBehaviour
    {
        ...
        public WaypointsContainer_Car[] doNotConnectTo;
        ...
        [HideInInspector]
        public WaypointsContainer_Car[] nextWay0;
        [HideInInspector]
        public WaypointsContainer_Car[] nextWay1;
        [HideInInspector]
        ...
        [HideInInspector]
        public WaypointsContainer_Car[] directConnectSide = new WaypointsContainer_Car[2];
            ...
            for (int idx = 1; idx >= 0; idx--)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    if (pathDistance < 3)
                    {
                        ...
                        if (idx == 0)
                        {
                            nextWay0 = new WaypointsContainer_Car[1];
                        ...
                        {
                            nextWay1 = new WaypointsContainer_Car[1];
        ...
        public void ResetWay()
        {
            ...
            nextWay0 = new WaypointsContainer_Car[0];
            nextWay1 = new WaypointsContainer_Car[0];
            ...
            for (int idx = 1; idx >= 0; idx--)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    if (pathDistance < limitNodeDistance && pathDistance >= 3)
                    {
                        ...
                        WaypointsContainer_Car wpc = wpData.tsParent[i];
                ...
                WaypointsContainer_Car[] _NextWays = new WaypointsContainer_Car[qt];
                int[] _NextWaysSide = new int[qt];

                for (int i = 0; i < qt; i++)
                {
                    _NextWays[i] = (WaypointsContainer_Car)arrParent[i];
        ...
        public bool TestDoNotConnectTo(WaypointsContainer_Car t)
        {
...
#if UNITY_EDITOR
                if (!trafficSystem)
                    trafficSystem = (TrafficSystem_Car)AssetDatabase.LoadAssetAtPath("Assets/cky - Traffic System/Resources/Traffic System/Traffic System - Car.prefab", (typeof(TrafficSystem_Car)));
#endif

                if (!trafficSystem)
                    Debug.LogError("Traffic System - Car.prefab was not found in 'Assets/cky - Traffic System/Resources/Traffic System'");
            }
